<x-app-layout pageTitle="Add New Lesson">
    <div class="max-w-3xl mx-auto">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">New Lesson</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new lesson for one of your students</p>
            </div>

            <form action="{{ route('teacher.lessons.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    @if($students->isEmpty())
                        <p class="mt-2 text-sm text-yellow-600 dark:text-yellow-400">No students assigned to you yet.</p>
                    @endif
                    @error('student_id')
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('teacher.lessons.index') }}" class="px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        Cancel
                    </a>
