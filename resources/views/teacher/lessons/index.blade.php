<x-app-layout pageTitle="My Classes">
    <div class="space-y-6">
        <!-- Header -->
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $lesson->student->name }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if($lesson->isAcademyPaid())
                                        <div class="mt-1">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-300" title="Free for the student — the academy pays you for this lesson">
                                                Paid by academy
                                            </span>
                                        </div>
                                    @endif
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="inline-flex items-center justify-end gap-2">
                                        <a href="{{ route('teacher.lessons.edit', $lesson) }}"
                                           class="inline-flex items-center px-3 py-2 text-xs font-medium rounded-lg text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 transition-colors">
                                        ...
                                        <form action="{{ route('teacher.lessons.destroy', $lesson) }}" method="POST"
                                              onsubmit="return confirm('Delete this lesson? Related billing and salary totals will be recalculated. This cannot be undone.');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                    class="inline-flex items-center px-3 py-2 text-xs font-medium rounded-lg text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 transition-colors">
                                                <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No lessons match the selected filters.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
