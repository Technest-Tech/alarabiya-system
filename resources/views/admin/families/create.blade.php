<x-app-layout pageTitle="Create Family">
    <div class="max-w-4xl mx-auto space-y-8">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Add a Family</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Group one or more students with shared billing details.
                </p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.families.store') }}" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-6 space-y-6">
            @csrf
