...
return [
    'timezones' => [
        ...
        // United States (valid IANA identifiers)
        'America/New_York' => 'United States - Eastern (New York, Washington DC, Atlanta, Miami)',
        'America/Detroit' => 'United States - Eastern (Detroit)',
        'America/Indiana/Indianapolis' => 'United States - Eastern (Indianapolis)',
        'America/Chicago' => 'United States - Central (Chicago, Dallas, Houston, New Orleans, Memphis, Kansas City, Minneapolis)',
        'America/Denver' => 'United States - Mountain (Denver, Salt Lake City)',
        'America/Phoenix' => 'United States - Mountain (Phoenix - No DST)',
        'America/Los_Angeles' => 'United States - Pacific (Los Angeles, San Francisco, Seattle, Portland, Las Vegas)',
        'America/Anchorage' => 'United States - Alaska (Anchorage)',
        'Pacific/Honolulu' => 'United States - Hawaii (Honolulu)',
    ],
];
